        ...
        private class DatabaseCallback(private val context: Context) : RoomDatabase.Callback() {
            ...
            private fun seedDatabase() {
                CoroutineScope(Dispatchers.IO).launch {
                    ...
                    // Day 1-5: 기초 명사 (Basic Nouns)
                    // Day 6-10: 일상 동사 및 형용사 (Common Verbs & Adjectives)
                    // Day 11-15: 비즈니스 및 사회 (Business & Society)
                    // Day 16-20: 관용구 및 고난도 단어 (Idioms & Advanced)
                    ...
                    val daysData = listOf(
                        ...
                        // Day 7
                        listOf("Feel" to "느끼다", "Try" to "시도하다", "Leave" to "떠나다", "Call" to "부르다", "Good" to "좋은", "New" to "새로운", "First" to "첫 번째의", "Last" to "마지막의", "Long" to "긴", "Great" to "위대한", "Little" to "작은", "Own" to "자신의", "Other" to "다른", "Old" to "오래된", "High" to "높은", "Next" to "다음의", "Early" to "이른", "Young" to "젊은", "Important" to "중요한", "Few" to "거의 없는"),
                        // Day 8
                        listOf("Public" to "공공의", "Bad" to "나쁜", "Same" to "같은", "Able" to "할 수 있는", "Big" to "큰", "Small" to "작은", "Large" to "거대한", "Better" to "더 나은", "Best" to "최고의", "Possible" to "가능한", "True" to "진실한", "Full" to "가득 찬", "Special" to "특별한", "Easy" to "쉬운", "Clear" to "명확한", "Recent" to "최근의", "Certain" to "확실한", "Personal" to "개인적인", "Open" to "열린", "Short" to "짧은"),
                        // Day 9
                        listOf("Real" to "진짜의", "Single" to "단일의", "Medical" to "의료의", "Current" to "현재의", "Past" to "과거의", "Future" to "미래의", "Free" to "자유로운", "Strong" to "강한", "Happy" to "행복한", "Wait" to "기다리다", "Serve" to "봉사하다/공급하다", "Die" to "죽다", "Send" to "보내다", "Expect" to "기대하다", "Build" to "짓다", "Stay" to "머무르다", "Fall" to "떨어지다", "Cut" to "자르다", "Reach" to "도달하다", "Kill" to "죽이다"),
                        // Day 10
                        listOf("Remain" to "남다", "Suggest" to "제안하다", "Raise" to "올리다/기르다", "Pass" to "통과하다", "Sell" to "팔다", "Require" to "요구하다", "Report" to "보고하다", "Decide" to "결정하다", "Pull" to "당기다", "Push" to "밀다", "Explain" to "설명하다", "Hope" to "희망하다", "Develop" to "개발하다", "Carry" to "운반하다", "Drive" to "운전하다", "Break" to "깨뜨리다", "Buy" to "사다", "Agree" to "동의하다", "Cover" to "덮다", "Catch" to "잡다"),
                        // Day 11
